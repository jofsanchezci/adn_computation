...
def test_cases():
    """Casos de prueba para la simulación."""
    print("\n=== Caso de prueba 1: Grafo pequeño ===")
    graph = generate_graph(3)
    edges = generate_edges(graph)
    paths = find_hamiltonian_paths(graph, edges)
    print("Nodos:", graph)
    print("Conexiones:", edges)
    print("Caminos Hamiltonianos:", paths)
